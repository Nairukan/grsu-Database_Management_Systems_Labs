...
--
-- Data for Name: customercontacts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.customercontacts (customer_id, contact_information) FROM stdin;
1	alice@example.com
2	bob@example.com
...
COPY public.customers (customer_id, full_name) FROM stdin;
1	Alice Johnson
2	Bob Miller
3	Charlie Davis
\.
...
COPY public.employees (employee_id, full_name, specialization) FROM stdin;
1	John Doe	Technician
2	Jane Smith	Customer Support
3	Bob Johnson	Technician
\.
...
COPY public.parts (part_id, part_name, quantity_in_stock, cost) FROM stdin;
1	Screen	10	50.00
2	Battery	20	30.00
3	Software Update License	5	10.00
\.
...
COPY public.payments (payment_id, amount, payment_method, payment_date, repair_id) FROM stdin;
1	150.00	Credit Card	2023-01-10 00:00:00	1
2	80.00	PayPal	2023-02-05 00:00:00	2
3	120.00	Cash	2023-03-02 00:00:00	3
\.
...
COPY public.phones (phone_id, model, manufacturer, year_of_manufacture, serial_number) FROM stdin;
1	iPhone 12	Apple	2020	SN123456
2	Galaxy S21	Samsung	2021	SN789012
3	Pixel 5	Google	2020	SN345678
\.
...
COPY public.repair_details (repair_id, part_id) FROM stdin;
1	1
2	2
3	3
4	2
...
--
-- Data for Name: repairdates; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.repairdates (repair_id, start_date, end_date) FROM stdin;
...
COPY public.repairs (repair_id, phone_id, service_id, status_id, customer_id, employee_id) FROM stdin;
1	1	1	1	1	1
4	1	2	1	1	1
2	2	2	2	2	3
3	3	3	3	3	2
...
--
-- Data for Name: repairstatus; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.repairstatus (status_id, status_description) FROM stdin;
1	In Progress
2	Completed
...
COPY public.reviews (review_id, rating, comments, repair_id) FROM stdin;
1	5	Great service!	1
2	3	Average experience	2
3	5	Excellent job!	3
\.
...
COPY public.services (service_id, service_type) FROM stdin;
...
--
-- Data for Name: workdescriptions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.workdescriptions (repair_id, description) FROM stdin;
1	Replace broken screen
2	Replace old battery
3	Update to the latest OS
4	Replace old battery
\.
...
SELECT pg_catalog.setval('public.phones_phone_id_seq', 1, false);
...
--
-- Name: repairstatus_status_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.repairstatus_status_id_seq', 1, false);
